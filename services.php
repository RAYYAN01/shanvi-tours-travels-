...
<section class="section-padding">
    <div class="container">
        ...
        <!-- Employee Transport -->
        <div id="employee-transport" class="row align-items-center mb-5 pb-5 border-bottom">
        ...
        <div class="row g-4">
            <div class="col-md-3 col-sm-6">
                <div class="stat-item">
                    ...
                    <h5 style="font-size: 1.2rem; color: var(--text-dark); margin: 1rem 0;">Licensed & Insured</h5>
                    <p>All vehicles fully licensed and comprehensively insured</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stat-item">
                    <h4><i class="fas fa-tools"></i></h4>
                    <h5 style="font-size: 1.2rem; color: var(--text-dark); margin: 1rem 0;">Well Maintained</h5>
                    <p>Regular servicing and quality checks on all vehicles</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stat-item">
                    <h4><i class="fas fa-user-check"></i></h4>
                    <h5 style="font-size: 1.2rem; color: var(--text-dark); margin: 1rem 0;">Verified Drivers</h5>
                    <p>Background-checked, trained, and experienced drivers</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="stat-item">
                    <h4><i class="fas fa-money-bill-wave"></i></h4>
                    <h5 style="font-size: 1.2rem; color: var(--text-dark); margin: 1rem 0;">Transparent Pricing</h5>
...
<!-- Service catalogue structured data -->
